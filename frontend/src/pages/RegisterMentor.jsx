...
const RegisterMentor = () => {
  ...
  // ✅ Google auth handled by shared hook
  useGoogleAuth({
    btnRef: googleBtnRef,
    termsAcceptedRef,
    roles: ["mentor"],
...
setTimeout(() => navigate("/dashboard/mentor"), 700);
    },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/verify-email", { state: { email: form.email.trim() } }), 800);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md border rounded-xl p-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Create your LeapMentor mentor account.</p>
